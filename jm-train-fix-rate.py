...
def parse_args():
    ...
    parser.add_argument('--weights',    type=str,  default=None) #'/mnt/e/lossy-vae/qres34m-lmb2048.pt')
    parser.add_argument('--load_optim', action=argparse.BooleanOptionalAction, default=False)
    # data setting
    parser.add_argument('--trainset',   type=str,  default='s9-400x400x730-tarin')
    parser.add_argument('--transform',  type=str,  default='crop=256,hflip=True,test=True')
    parser.add_argument('--valset',     type=str,  default='s9-400x400x730-val')
